...
class ResortViewController: UIViewController {
    ...
    @IBAction func seeAllTapped(_ sender: UIButton) {
        performSegue(withIdentifier: "showResortList", sender: nil)
    }
}


extension ResortViewController: UICollectionViewDataSource {
...
extension ResortViewController: UICollectionViewDelegateFlowLayout {
...
extension ResortViewController: UICollectionViewDelegate {
